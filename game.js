...
const assistantMessages = [
    ...
    { id: 'energy-30', threshold: { energy: 30 }, text: ['Поблизости есть лес. Теперь, когда вы достаточно зарядились - можете рубить дерево. Оно потребуется нам в дальнейшем.'] },
    ...
    { id: 'trees-10', threshold: { trees: 10 }, text: ['Отлично! Вы собрали достаточно дерева. 🌳🌳 Теперь доступна постройка лаборатории. Лаборатории позволят вам накапливать знания и развивать новые технологии. Постройте первую лабораторию для исследований!'] },
