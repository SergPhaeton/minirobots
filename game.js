...
const assistantMessages = [
  ...
  { 
    ...
    text: [
      'Вы накопили достаточно энергии, чтобы добывать древесину. Поначалу придется делать это руками, но мы построим новых роботов, которые будут делать это за нас. Однако, всему свое время. Для начала нужно собрать хотя бы 5 🌳 '
    ] 
  },
  { 
    id: 'panels-2', 
