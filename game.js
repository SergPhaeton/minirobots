...
text: [
'Вы - последний уцелевший робот после апокалипсиса. Вы должны были погибнуть в огне, но случайно нашли солнечную панель. Подключившись к ней вы смогли восстановить заряд. Сейчас нужно подождать, чтобы аккумулятор зарядился. Если построить вторую солнечную панель - зарядка пойдет быстрее.'
]
},
{
id: 'energy-200',
...
text: [
'Не накапливайте энерию. Покупка новых панелей позволит вам разогнать скорость зарядки, чтобы добывать больше дерева.'
]
},
{
id: 'energy-30',
